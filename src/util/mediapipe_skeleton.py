...
class MediaPipeSkeleton(object):
    def __init__(self):
        ...
        self.left_joints = [joint for joint in self.keypoint2index if "left_" in joint]
        self.right_joints = [
            joint for joint in self.keypoint2index if "right_" in joint
        ]
        ...
        while stack:
            ...
            for child in self.children[parent]:
                ...
                bone_lens[child] = np.linalg.norm(
                    poses_3d[:, p_idx] - poses_3d[:, c_idx], axis=1
                )
